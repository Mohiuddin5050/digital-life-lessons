    ...
    <section className="my-20 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="card bg-base-100 shadow-md text-center p-6">
          ...
          <h3 className="font-semibold text-lg mb-2">Builds Self-Awareness</h3>
          <p className="text-sm text-gray-500">
            Understanding past experiences helps you recognize patterns and make
            better decisions.
          </p>
        </div>
        ...
        <div className="card bg-base-100 shadow-md text-center p-6">
          ...
          <p className="text-sm text-gray-500">
            Reflecting on emotions strengthens empathy, gratitude, and emotional
            intelligence.
          </p>
        </div>
